      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-800">
        ...
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between">
            ...
            <h1 className={`text-xl font-extralight ${darkText}`}>developedbymaak</h1>
            <ul className="flex items-center">
              <li>
                <BsFillMoonStarsFill
                  onClick={() => setDarkMode(!darkMode)}
                  className={`cursor-pointer text-2xl text-black ${darkText}`}
                />
              </li>
              <li>
                <a
        ...
        <section>
          <div>
            <h3 className="text-3xl py1 md:text-3xl max-w-xl mx-auto dark:text-slate-200">
              Services I offer
            </h3>
